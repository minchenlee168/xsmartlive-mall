...
/**
 * 隱私權政策：供新分頁開啟的純內容頁，不含 NavBar / 分類列 / 返回鈕。
 * 章節：段落 paras、編號清單 items（可含清單前引言 itemsIntro）。
 */
...
const INTRO =
  '非常歡迎您光臨「直播管家」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：';
...
<template>
  <main class="mx-auto w-full max-w-[860px] px-4 py-8">
    <h1 class="mb-6 text-2xl font-bold text-slate-950">隱私權政策</h1>
