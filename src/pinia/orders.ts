...
export const useOrdersStore = defineStore('orders', () => {
  const orders = ref<OrderRecord[]>([
    ...
    },
    {
      ...
      qty: 1,
      total: 490,
      amounts: { goodsTotal: 490, shippingFee: 60, shippingDiscount: 60 },
      payment: '超商代碼繳費',
      delivery: '超商取貨',
      invoice: '個人發票（紙本）',
      invoiceStatus: 'pending',
    ...
    },
    {
      ...
      qty: 1,
      total: 290,
      amounts: { goodsTotal: 290, shippingFee: 80, shippingDiscount: 80 },
      payment: '貨到付款',
      delivery: '宅配',
      invoice: '手機條碼',
      invoiceStatus: 'issued',
    ...
    // ── 終點貨態示範訂單（退貨中 / 已退貨 / 已換貨 / 已取消）──
    // 由商家後台標記後同步到前台，買家端只呈現結果、無自助申請入口。
    {
      id: '15',
      ...
      qty: 1,
      total: 560,
      amounts: { goodsTotal: 560, shippingFee: 80, shippingDiscount: 80 },
      payment: '線上信用卡',
      delivery: '宅配',
      invoice: '會員載具',
      invoiceStatus: 'issued',
      status: 'completed',
      overrideStatus: 'returning',
    ...
    },
    {
      ...
      qty: 1,
      total: 650,
      amounts: { goodsTotal: 650, shippingFee: 80, shippingDiscount: 80 },
      payment: '線上信用卡',
      delivery: '宅配',
      invoice: '會員載具',
    ...
    },
    {
      ...
      qty: 1,
      total: 890,
      amounts: { goodsTotal: 890, shippingFee: 80, shippingDiscount: 80 },
      payment: '線上信用卡',
      delivery: '宅配',
      invoice: '會員載具',
      invoiceStatus: 'issued',
      status: 'completed',
      overrideStatus: 'exchanged',
      payStatus: 'paid',
      detailTab: 'progress',
      expanded: false,
      items: [
    ...
    {
      id: '18',
      date: '2026/01/25 10:05',
      orderNo: '1000000013',
      qty: 2,
      total: 540,
      amounts: { goodsTotal: 540, shippingFee: 80, shippingDiscount: 80 },
      payment: '線上信用卡',
      delivery: '宅配',
      invoice: '會員載具',
      invoiceStatus: 'pending',
      ...
      payStatus: 'refund_pending',
      cancelTime: '2026/01/25 14:32',
      cancelReason: '商品缺貨，已與買家確認後作廢',
      detailTab: 'progress',
      expanded: false,
      items: [
        {
    ...
    {
      id: '26',
      date: '2026/01/24 09:10',
      orderNo: '1000000026',
      qty: 1,
      total: 320,
      amounts: { goodsTotal: 320 },
      payment: '超商代碼繳費',
      delivery: '超商取貨',
      invoice: '手機條碼',
      invoiceStatus: 'pending',
      ...
      overrideStatus: 'cancelled',
      payStatus: 'unpaid',
      cancelTime: '2026/01/25 00:00',
      cancelReason: '逾期未完成付款，系統自動取消',
      detailTab: 'progress',
      expanded: false,
      items: [
        {
    ...
    },
    {
      ...
      qty: 1,
      total: 780,
      amounts: { goodsTotal: 780, shippingFee: 80, shippingDiscount: 80 },
      payment: '線上信用卡',
      delivery: '宅配',
      invoice: '會員載具',
      invoiceStatus: 'voided',
      ...
      overrideStatus: 'cancelled',
      payStatus: 'refunded',
      cancelTime: '2026/01/21 10:15',
      cancelReason: '買家付款後取消，已完成退款',
      detailTab: 'progress',
      expanded: false,
      items: [
        {
