...
export const products: Product[] = [
  ...
  },
  {
    ...
    skus: [
      ...
      { id: 's3-66-05', spec: { 尺寸: '66cm', 顏色: '鵝黃' }, stock: 45 },
      { id: 's3-66-06', spec: { 尺寸: '66cm', 顏色: '奶茶' }, stock: 3 },
      { id: 's3-66-07', spec: { 尺寸: '66cm', 顏色: '珊瑚橘' }, stock: 90 },
      { id: 's3-66-08', spec: { 尺寸: '66cm', 顏色: '丁香紫' }, stock: 17 },
      ...
      { id: 's3-73-06', spec: { 尺寸: '73cm', 顏色: '奶茶' }, stock: 72 },
      { id: 's3-73-07', spec: { 尺寸: '73cm', 顏色: '珊瑚橘' }, stock: 0 },
      { id: 's3-73-08', spec: { 尺寸: '73cm', 顏色: '丁香紫' }, stock: 2 },
      { id: 's3-73-09', spec: { 尺寸: '73cm', 顏色: '石墨灰' }, stock: 95 },
      { id: 's3-73-10', spec: { 尺寸: '73cm', 顏色: '磚紅' }, stock: 31 },
      { id: 's3-80-01', spec: { 尺寸: '80cm', 顏色: '奶油白' }, stock: 140 },
      { id: 's3-80-02', spec: { 尺寸: '80cm', 顏色: '霧藍' }, stock: 0 },
      { id: 's3-80-03', spec: { 尺寸: '80cm', 顏色: '櫻花粉' }, stock: 12 },
      { id: 's3-80-04', spec: { 尺寸: '80cm', 顏色: '薄荷綠' }, stock: 58 },
      { id: 's3-80-05', spec: { 尺寸: '80cm', 顏色: '鵝黃' }, stock: 4 },
      { id: 's3-80-06', spec: { 尺寸: '80cm', 顏色: '奶茶' }, stock: 27 },
      { id: 's3-80-07', spec: { 尺寸: '80cm', 顏色: '珊瑚橘' }, stock: 83 },
      { id: 's3-80-08', spec: { 尺寸: '80cm', 顏色: '丁香紫' }, stock: 0 },
      { id: 's3-80-09', spec: { 尺寸: '80cm', 顏色: '石墨灰' }, stock: 19 },
      { id: 's3-80-10', spec: { 尺寸: '80cm', 顏色: '磚紅' }, stock: 49 },
    ],
    category: '寶寶包屁',
    image:
  ...
  },
  {
    ...
    // 多軸 SKU（尺寸 × 顏色 × 袖長，模擬最多三軸、各軸多選項）+ 庫存；供直播得標後挑選規格使用
    specAxes: [
      { name: '尺寸', options: ['100cm', '110cm', '120cm', '130cm'] },
      {
        name: '顏色',
        options: ['粉色', '象牙白', '香檳金', '天空藍', '薄荷綠'],
      },
      { name: '袖長', options: ['短袖', '長袖'] },
    ],
    skus: [
      {
        id: 's5-01',
      ...
      {
        id: 's5-02',
        spec: { 尺寸: '100cm', 顏色: '粉色', 袖長: '長袖' },
        stock: 7,
      },
      {
        id: 's5-03',
        spec: { 尺寸: '100cm', 顏色: '象牙白', 袖長: '短袖' },
        stock: 58,
      },
      {
        id: 's5-04',
        spec: { 尺寸: '100cm', 顏色: '象牙白', 袖長: '長袖' },
        stock: 0,
      },
      {
        id: 's5-05',
        spec: { 尺寸: '100cm', 顏色: '香檳金', 袖長: '短袖' },
        stock: 21,
      },
      {
        id: 's5-06',
        spec: { 尺寸: '100cm', 顏色: '香檳金', 袖長: '長袖' },
        stock: 3,
      },
      {
        id: 's5-07',
        spec: { 尺寸: '110cm', 顏色: '粉色', 袖長: '短袖' },
        stock: 96,
      },
      {
        id: 's5-08',
        spec: { 尺寸: '110cm', 顏色: '粉色', 袖長: '長袖' },
        stock: 44,
      },
      {
        id: 's5-09',
        spec: { 尺寸: '110cm', 顏色: '象牙白', 袖長: '短袖' },
        stock: 15,
      },
      {
        id: 's5-10',
        spec: { 尺寸: '110cm', 顏色: '象牙白', 袖長: '長袖' },
        stock: 80,
      },
      {
        id: 's5-11',
        spec: { 尺寸: '110cm', 顏色: '香檳金', 袖長: '短袖' },
        stock: 0,
      },
      {
        id: 's5-12',
        spec: { 尺寸: '110cm', 顏色: '香檳金', 袖長: '長袖' },
        stock: 29,
      },
      {
        id: 's5-13',
        spec: { 尺寸: '120cm', 顏色: '粉色', 袖長: '短袖' },
        stock: 6,
      },
      {
        id: 's5-14',
        spec: { 尺寸: '120cm', 顏色: '粉色', 袖長: '長袖' },
        stock: 110,
      },
      {
        id: 's5-15',
        spec: { 尺寸: '120cm', 顏色: '象牙白', 袖長: '短袖' },
        stock: 38,
      },
      {
        id: 's5-16',
        spec: { 尺寸: '120cm', 顏色: '象牙白', 袖長: '長袖' },
        stock: 2,
      },
      {
        id: 's5-17',
        spec: { 尺寸: '120cm', 顏色: '香檳金', 袖長: '短袖' },
        stock: 67,
      },
      {
        id: 's5-18',
        spec: { 尺寸: '120cm', 顏色: '香檳金', 袖長: '長袖' },
        stock: 19,
      },
      {
        id: 's5-19',
        spec: { 尺寸: '130cm', 顏色: '粉色', 袖長: '短袖' },
        stock: 0,
      },
      {
        id: 's5-20',
        spec: { 尺寸: '130cm', 顏色: '粉色', 袖長: '長袖' },
        stock: 90,
      },
      {
        id: 's5-21',
        spec: { 尺寸: '130cm', 顏色: '象牙白', 袖長: '短袖' },
        stock: 5,
      },
      {
        id: 's5-22',
        spec: { 尺寸: '130cm', 顏色: '象牙白', 袖長: '長袖' },
        stock: 51,
      },
      {
        id: 's5-23',
        spec: { 尺寸: '130cm', 顏色: '香檳金', 袖長: '短袖' },
        stock: 26,
      },
      {
        id: 's5-24',
        spec: { 尺寸: '130cm', 顏色: '香檳金', 袖長: '長袖' },
        stock: 120,
      },
      {
        id: 's5-25',
        spec: { 尺寸: '100cm', 顏色: '天空藍', 袖長: '短袖' },
        stock: 9,
      },
      {
        id: 's5-26',
        spec: { 尺寸: '100cm', 顏色: '天空藍', 袖長: '長袖' },
        stock: 73,
      },
      {
        id: 's5-27',
        spec: { 尺寸: '110cm', 顏色: '天空藍', 袖長: '短袖' },
        stock: 34,
      },
      {
        id: 's5-28',
        spec: { 尺寸: '110cm', 顏色: '天空藍', 袖長: '長袖' },
        stock: 11,
      },
      {
        id: 's5-29',
        spec: { 尺寸: '120cm', 顏色: '天空藍', 袖長: '短袖' },
        stock: 145,
      },
      {
        id: 's5-30',
        spec: { 尺寸: '120cm', 顏色: '天空藍', 袖長: '長袖' },
        stock: 48,
      },
      {
        id: 's5-31',
        spec: { 尺寸: '130cm', 顏色: '天空藍', 袖長: '短袖' },
        stock: 4,
      },
      {
        id: 's5-32',
        spec: { 尺寸: '130cm', 顏色: '天空藍', 袖長: '長袖' },
        stock: 0,
      },
      {
        id: 's5-33',
        spec: { 尺寸: '100cm', 顏色: '薄荷綠', 袖長: '短袖' },
        stock: 0,
      },
      {
        id: 's5-34',
        spec: { 尺寸: '100cm', 顏色: '薄荷綠', 袖長: '長袖' },
        stock: 88,
      },
      {
        id: 's5-35',
        spec: { 尺寸: '110cm', 顏色: '薄荷綠', 袖長: '短袖' },
        stock: 23,
      },
      {
        id: 's5-36',
        spec: { 尺寸: '110cm', 顏色: '薄荷綠', 袖長: '長袖' },
        stock: 62,
      },
      {
        id: 's5-37',
        spec: { 尺寸: '120cm', 顏色: '薄荷綠', 袖長: '短袖' },
        stock: 16,
      },
      {
        id: 's5-38',
        spec: { 尺寸: '120cm', 顏色: '薄荷綠', 袖長: '長袖' },
        stock: 99,
      },
      {
        id: 's5-39',
        spec: { 尺寸: '130cm', 顏色: '薄荷綠', 袖長: '短袖' },
        stock: 31,
      },
      {
        id: 's5-40',
        spec: { 尺寸: '130cm', 顏色: '薄荷綠', 袖長: '長袖' },
        stock: 55,
      },
    ],
    category: '小童童裝',
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1596870230751-ebdfce98ec42?w=600&fit=crop',
    // 固定組合：兩款不同款式洋裝固定搭配，規格＝顏色,尺寸（彈窗選擇）
    isBundle: true,
    noCoupon: true,
    bundleItems: [
      {
